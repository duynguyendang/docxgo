...
func addCover(doc domain.Document) error {
	...
	if err := titleRun.SetText("go-docx v3 Table of Contents Demo"); err != nil {
...
func addAppendix(doc domain.Document) error {
	...
	resources := []string{
		"API reference: pkg.go.dev/github.com/duynguyendang/docxgo/v3",
		"Examples: github.com/duynguyendang/docxgo/examples",
